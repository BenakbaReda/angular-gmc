...
const routes: Routes = [
  ...
  {path:'StructuralDirectives*Ngif', 	component :  StructuralDirectivesNgifComponent}, 	
  {path:'StructuralDirectives*Ngfor', component :  StructuralDirectivesNgforComponent}, 
